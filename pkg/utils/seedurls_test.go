...
func TestGetBruteForcedUrls(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := GetBruteForcedUrls(tt.domain, tt.registeredDomain)
...
func TestGetBruteForcedUrlsURLValidity(t *testing.T) {
	...
	got, err := GetBruteForcedUrls("example.com", "example.com")
	if err != nil {
...
func BenchmarkGetBruteForcedUrls(b *testing.B) {
	for i := 0; i < b.N; i++ {
		GetBruteForcedUrls("example.com", "example.com")
	}
}
